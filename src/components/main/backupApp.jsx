...
export default function App() {
  ...
  <div className="buy-container">
    ...
    <h2 className="buy-title">Referral Token Buy</h2>
    ...
    <div className="buy-card">
      ...
      <div className="buy-row">
        ...
        <span>{referralTokenEstimate.toFixed(6)}</span>
      </div>
    ...
    <div className="status-card">
      <div><b>Config PDA:</b> {CONFIG.toBase58()}</div>
      <div><b>Vault Authority:</b> {VAULT_AUTHORITY.toBase58()}</div>
      <div><b>Vault Token ATA:</b> {VAULT_TOKEN.toBase58()}</div>
      <div><b>Buyer USDT (raw):</b> {status.buyerUsdtRaw}</div>
      <div><b>Vault Project Token (raw):</b> {status.vaultTokenRaw}</div>
