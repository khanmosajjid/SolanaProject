                                ...
                                <div className="footer-widget">
                                    ...
                                    <div className="footer-link">
                                        <ul className="list-wrap">
                                            ...
                                            <li><a href="#chart">Plateform</a></li>
                            ...
                            <div className="col-xl-3 col-lg-2 col-md-4 col-sm-6">
                                <div className="footer-widget">
                                    ...
                                    <ul className="footer-social-link">
                                        <li>
                                            <a href="https://www.facebook.com/share/1BtpSnWPmH/" target="_blank" rel="noreferrer">
                                                <i className="fab fa-facebook-f"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://x.com/LootLaugh" target="_blank" rel="noreferrer">
                                                <i className="fab fa-twitter"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.instagram.com/loot_laugh" target="_blank" rel="noreferrer">
                                                <i className="fab fa-instagram"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://t.me/lootlaugh" target="_blank" rel="noreferrer">
                                                <i className="fab fa-telegram-plane"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.youtube.com/@LootLaugh-j3i" target="_blank" rel="noreferrer">
                                ...
                                <div className="footer-widget">
                                    ...
                                    <div class="footer-newsletter">
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <input type="email" className="footer-email" placeholder="info@gmail.com" required />
                                            <button type="submit">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="copyright-text text-center">
                                    <p>
                                        Copyright © 2026 <a href="/">LootLaugh</a> All rights reserved.
                                    </p>
                                </div>
                            </div>
                        </div>
